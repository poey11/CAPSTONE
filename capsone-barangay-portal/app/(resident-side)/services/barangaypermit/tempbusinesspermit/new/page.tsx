...
import "@/CSS/ServicesPage/barangaypermit/tempbusinesspermit/new.css";



const metadata:Metadata = { 
  title: "Barangay Temporary Business Permit (New)",
  description: "Barangay Temporary Business Permit (New) form page for the barangay website",
};
export default function BarangayTemporaryBusinessPermitNew() {
    ...
    <div className="form-container">
      ...
      <div className="form-content">
        <h1 className="form-title">
            Barangay Temporary Business Permit
        </h1>
