...
const metadata:Metadata = { 
  title: "Barangay Temporary Business Permit (Renewal)",
  description: "Barangay Temporary Business Permit (Renewal) form page for the barangay website",
};
export default function BarangayTemporaryBusinessPermitRenewal() {
