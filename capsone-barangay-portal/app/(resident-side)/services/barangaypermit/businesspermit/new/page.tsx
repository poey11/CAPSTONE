...
import "@/CSS/ServicesPage/barangaypermit/businesspermit/new.css";


const metadata:Metadata = { 
  title: "Barangay Business Permit (New)",
  description: "Barangay Business Permit (New) form page for the barangay website",
};
export default function BarangayBusinessPermitNew() {
