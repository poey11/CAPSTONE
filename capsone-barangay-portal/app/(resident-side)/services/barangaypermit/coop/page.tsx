...
import "@/CSS/ServicesPage/barangaypermit/coop/coop.css";

/*not sure pa sa contents ng form*/

const metadata:Metadata = { 
  title: "Barangay COOP Permit",
  description: "Barangay COOP Permit form page for the barangay website",
};
export default function BarangayCOOPPermit() {
