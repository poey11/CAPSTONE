...
import "@/CSS/ServicesPage/barangaypermit/liquorpermit/liquorpermit.css";

/*not sure pa sa contents ng form*/

const metadata:Metadata = { 
  title: "Barangay Liquor Permit",
  description: "Barangay Liquor Permit form page for the barangay website",
};
export default function BarangayLiquorPermit() {
