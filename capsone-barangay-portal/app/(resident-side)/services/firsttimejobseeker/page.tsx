...
const metadata:Metadata = { 
  ...
  description: "First Time Jobseeker form page for the barangay website",
};
  ...
  return (
    ...
    <div className="form-container">
      ...
      <style jsx>{`
        ...
        gap: 0.5rem; /* Add space between the radio buttons */
        }

        .form-radio {
        display: flex;
        align-items: center; /* Align radio button and label */
        gap: 0.5rem; /* Add space between the button and text */
        color: rgba(0, 0, 0, 0.6);
        }
