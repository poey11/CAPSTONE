...
export default function EditGADIncident() {
    ...
    const handleGenerateDialouge = () => {
        router.push("/dashboard/IncidentModule/GAD/EditIncident/DialogueLetter");
      };

      const handleGenerateSummonLetter = () => {
        router.push("/dashboard/IncidentModule/GAD/EditIncident/SummonLetter");
      };
