...
export default function addAnnouncements() {
    ...
    const confirmCreate = async () => {
        setShowCreatePopup(false);
                ...
                setTimeout(() => {
                    setShowPopup(false);
                    router.push("/dashboard/ServicesModule/InBarangayRequests/View/BarangayPermit/ConstructionPermit");
                }, 3000);
                        ...
                        <div className="section-left">
                            <div className="fields-container">
                                <div className="fields-section">
                                    <p>Type of Construction Activity</p>
                                    <select 
                                        id="businessActivity" 
                                        ...
                                        defaultValue=""  
                                    >
                                        <option value="" disabled>Construction Activity</option>
                                        <option value="Male">Structure</option>
                                        <option value="Female">Renovation</option>
                                        <option value="Female">Fencing</option>
                                        <option value="Female">Excavation</option>
                                        <option value="Female">Demolition</option>
                                    </select>
                                </div>
