...
const metadata: Metadata = {
    title: "View Barangay Certificate of Residency Appointment Details",
    description: "View Barangay Certificate of Residency Appointment Details in Services Module",
  };
...
export default function EditAppointment() {
    ...
    const handleviewdocumentdetails = () => {
        window.location.href = "/dashboard/ServicesModule/OnlineRequests/View/BarangayCertificate";
    };
            ...
            <div className="main-content">
                <div className="section-1">
                  <div className="left-section">
                    ...
                    <p>Barangay Certificate of Residency Appointment Details</p>
                  </div>
